...
START_TEST(s21_from_decimal_to_intTest8) {
  ...
  int *res = &result;
  s21_from_decimal_to_int(src1, res);
  ck_assert_int_eq(result, 796132800);
}
END_TEST
...
START_TEST(s21_from_decimal_to_intTest9) {
  ...
  int *res = &result;
  s21_from_decimal_to_int(src1, res);
  ck_assert_int_eq(result, -12345680);
}
END_TEST
